...
if __name__ == '__main__':
    ...
    parser.add_argument("-a", metavar='cafile', default=None, help="authority: path ot CA certificate PEM file")
    parser.add_argument("-s", metavar="certfile", default=None, help="run as server: path ot server PEM file")
